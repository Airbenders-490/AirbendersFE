...
class RemoveCurrentClassModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      modalVisible: false,
  ...
  handleSubmit = () => {
    ...
    if (this.state.text.trim() !== '') {
      axios
        ...
        .then(
          response => {
            console.log("REMOVE CURRENT CLASS RESPONSE " + response.data);
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={styles.modalText}>Remove A Current Class</Text>
...
export default RemoveCurrentClassModal;